...
if __name__ == "__main__":
    ...
    start = [6,3,5]  # drone1's start: node 0;  drone2's start: node 2;  drone3's start: node 4;
    goal = [2,1,8]  # drone1's goal: node 3;  drone2's goal: node 6;  drone3's goal: node 1;
